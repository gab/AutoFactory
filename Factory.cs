...
namespace AutoFactory
{
    ...
    public static class Factory
    {
        ...
        public static IAutoFactory<TBase> Create<TBase>(Assembly assembly = null, object[] constructorParams = null, Type[] constructorParamTypes = null) where TBase : class
        {
            ...
            return CreateProc<TBase>(assembly, constructorParams, constructorParamTypes);
        }
        #endregion
        ...
        public static IAutoFactory Create(Type baseType, Assembly assembly = null, object[] constructorParams = null, Type[] constructorParamTypes = null)
        {
            ...
            var factory = (IAutoFactory)genericMethod.Invoke(null, new object[] { assembly, constructorParams, constructorParamTypes });
            return factory;
        }
        #endregion
        ...
        /// </summary>
        private static IAutoFactory<TBase> CreateProc<TBase>(Assembly assembly, object[] constructorParams, Type[] constructorParamTypes)
            where TBase : class
        {
            ...
            factory.ComposeParts(assembly, constructorParams, constructorParamTypes);
            return factory;
        }
        #endregion
    }
